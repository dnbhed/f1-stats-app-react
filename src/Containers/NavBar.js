...
const NavBar = props => {
  return (
    <Navbar bg="dark" variant="dark" id="nav-bar">
      <h1 id="logo-home" style={{ textDecoration: "none" }}>
        <Link to="/">F1 STATS</Link>
      </h1>
      <Button id="driver-stats-link">
        <Link to="/driver-stats" style={{ textDecoration: "none" }}>
          DRIVER STATS
        </Link>
      </Button>
      <Button id="compare-drivers-link">
        <Link to="/compare-drivers" style={{ textDecoration: "none" }}>
          COMPARE DRIVERS
        </Link>
      </Button>
